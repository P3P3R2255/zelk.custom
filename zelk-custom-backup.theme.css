...
/*---------------BASIC---------------*/
.theme-dark {
  --accent-color: #d8c4f1 !important;
  --background-1: #1a181e !important;
  --background-2: #221f26 !important;
  --border-color: #2d2832 !important;
  --background-mentioned: #d8c4f110 !important;
  --background-mentioned-hover: #8859c115 !important;
  ...
  --text-link: #CCCCFF !important;
  --settings-icon-color: #a293b4 !important;
  --tab-selected: #3d3745 !important;
  --switch: #47404f !important;
  --button-background: #302b36 !important;
  --button-background-hover: #3d3745 !important;
  --button-background-active: #595063 !important;
  --button-accent-hover: #e3d6f8 !important;
  --button-accent-active: #be9be7 !important;
  --button-destructive: #fb7c7c !important;
  --button-destructive-hover: #ff929b !important;
  --button-destructive-active: #fa4a4a !important;
}
.theme-light {
  --accent-color: #9f74e7 !important;
  --background-1: #ffffff !important;
  --background-2: #f9f7f9 !important;
  --border-color: transparent !important;
  --background-mentioned: #9f74e710 !important;
  --background-mentioned-hover: #9f74e715 !important;
  ...
  --tab-selected: var(--background-1) !important;
  --switch: #d4ced7 !important;
  --button-background: #ebe8ec !important;
  --button-background-hover: #ddd8df !important;
  --button-background-active: #c2bac5 !important;
  --button-accent-hover: #9f74e7 !important;
  --button-accent-active: #813fd0 !important;
  --button-destructive: #fb7c7c !important;
  --button-destructive-hover: #ff929b !important;
  --button-destructive-active: #fa4a4a !important;
}
:root {
  ...
  --background-modifier-selected: #ba96e79c !important;
